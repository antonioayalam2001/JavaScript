    ...
    (function (index) {
      squares[i].onclick = function () {
        if (squares[index + 7].classList.contains("taken")) {
            if (currentPlayer === 1) {
              displayCurrentPlayer.setAttribute('style','color:blue;')
              ...
              displayCurrentPlayer.innerHTML = currentPlayer;
                ...
                displayCurrentPlayer.setAttribute('style','color:red;')
                squares[index].classList.add("taken");
    ...
    const winningArrays = [
      ...
      for (let y = 0; y < winningArrays.length; y++){
          ...
          if (square1.classList.contains('player1') &&
              ...
              result.innerHTML = 'PlayerOneWins'
              console.log(square1);
              console.log(square2);
              console.log(square3);
              console.log(square4);
            } else if (square1.classList.contains('player2') &&
            square2.classList.contains('player2')&&
            square3.classList.contains('player2')&&
            square4.classList.contains('player2')) {
              result.innerHTML='PlayerTwoWins'              
          }
      }
    }
